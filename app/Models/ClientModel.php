...
class ClientModel extends Model
{
    ...
    protected EpargneModel $epargne_model;
    ...
    public function getEparge(int $id_client)
    {
        $db = \Config\Database::connect();

$this->epargne_model = new EpargneModel();
        /*
     ...
     */
        ...
        SELECT 
            COALESCE(SUM(
                CASE
                    ...
                    THEN -(t.montant + t.frais + t.commission) * e.frais/100
        ...
        JOIN t_epargne e
        ON e.id_client =t.id_client_cible
    ...
    ";
        ...
        return $soldeSource + $soldeCible *$this->epargne_model->getEpaarge($id_client);
    }
